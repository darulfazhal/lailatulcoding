...
<script src="<?php echo admin_assets('js/jquery-ui-1.9.2.custom.min.js') ?>"></script>
<script src="<?php echo admin_assets('js/jquery.ui.touch-punch.min.js') ?>"></script>
