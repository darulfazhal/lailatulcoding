...
<html lang="en">
  <head>
    ...
    <title>Lailatul Coding Admin</title>
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?php echo base_url(); ?>admin/login/do_login" method="POST">
		        ...
		        <div class="login-wrap">
		          ...
		          <!-- Modal -->
		          <form action="admin/login/do_forgot_password" method="POST">
    ...
    <script type="text/javascript" src="<?php echo admin_assets('js/jquery.backstretch.min.js') ?>"></script>
    <script>
        $.backstretch("<?php echo admin_assets('img/login-bg.jpg') ?>", {speed: 500});
    </script>
